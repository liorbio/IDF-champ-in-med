...
import { OneCorrectQuestionData } from "../../../../types/question-types";
...
import classes from './OneCorrectQuestion.module.css';
import { portalElement } from '../../../../elements/portalElement';

const OneCorrectQuestion: QuestionRfc<OneCorrectQuestionData> = ({ data }) => {
...
export default OneCorrectQuestion;